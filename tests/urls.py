...
urlpatterns = [
    ...
    re_path(
        r"^custom-check-logging-methods-fail$", test_views.MockCustomCheckLoggingWithLoggingMethodsFailView.as_view()
    ),
    ...
    re_path(r"^decode-request-body-false$", test_views.MockDecodeRequestBodyFalse.as_view()),
